...
public class One {
	public One(Player player) {
		PickLock.lockPicking.put(player, 1);
		Inventory gui = Bukkit.createInventory(null, 54, ChatColor.BLACK + "Memorize the puzzle 1");
		...
		gui.setItem(20, picked);
		gui.setItem(21, picked);
		gui.setItem(23, picked);
		gui.setItem(29, picked);
		gui.setItem(31, picked);
		gui.setItem(32, picked);
